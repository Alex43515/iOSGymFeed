...
class CreateExerciseWidget extends StatefulWidget {
  const CreateExerciseWidget({
    super.key,
    required this.woktoutRef,
    required this.userDetails,
  });

  final WorkoutRecord? woktoutRef;
...
class _CreateExerciseWidgetState extends State<CreateExerciseWidget> {
  ...
  void initState() {
    ...
    _model.exerciseNameSecondTextController ??= TextEditingController();
    _model.exerciseNameSecondFocusNode ??= FocusNode();

    _model.exerciseDescriptionSecondTextController ??= TextEditingController();
    _model.exerciseDescriptionSecondFocusNode ??= FocusNode();
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.exerciseNameSecondFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: FFLocalizations.of(context).getText(
                                  '6hc86d8d' /* Enter Exercise title */,
                                ),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode:
                                  _model.exerciseDescriptionSecondFocusNode,
                              autofocus: false,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: FFLocalizations.of(context).getText(
                                  'avkjaoli' /* Enter Exercise description */,
                                ),
                                labelStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: [
                              FFLocalizations.of(context).getText(
                                'avu78yir' /* Light Intensity */,
                              ),
                              FFLocalizations.of(context).getText(
                                'fezbdi1g' /* Moderate Intensity */,
                              ),
                              FFLocalizations.of(context).getText(
                                '9j5ldzkc' /* Maximal Intensity */,
                              )
                            ],
                            onChanged: (val) =>
