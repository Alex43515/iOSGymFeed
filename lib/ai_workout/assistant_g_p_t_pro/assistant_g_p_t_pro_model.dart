...
import 'assistant_g_p_t_pro_widget.dart' show AssistantGPTProWidget;
import 'package:flutter/material.dart';

class AssistantGPTProModel extends FlutterFlowModel<AssistantGPTProWidget> {
  ...
  // Stores action output result for [Backend Call - API (threads)] action in assistantGPTPro widget.
