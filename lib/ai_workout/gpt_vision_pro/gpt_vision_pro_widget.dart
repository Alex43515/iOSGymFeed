...
import 'gpt_vision_pro_model.dart';
export 'gpt_vision_pro_model.dart';

class GptVisionProWidget extends StatefulWidget {
  const GptVisionProWidget({super.key});

  static String routeName = 'gptVisionPro';
  static String routePath = 'gptVisionPro';

  @override
  State<GptVisionProWidget> createState() => _GptVisionProWidgetState();
}

class _GptVisionProWidgetState extends State<GptVisionProWidget> {
  late GptVisionProModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GptVisionProModel());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.alwayspopulatedTextController?.text =
            ...
            'q0ba38h5' /* Answer this question only if t... */,
          );
        }));
  }
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            '8imtvdro' /* What would you like to know ab... */,
                          ),
                          labelStyle:
