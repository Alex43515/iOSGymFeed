...
import 'assistant_g_p_t_model.dart';
export 'assistant_g_p_t_model.dart';

class AssistantGPTWidget extends StatefulWidget {
  const AssistantGPTWidget({super.key});

  static String routeName = 'assistantGPT';
  static String routePath = 'assistantGPT';

  @override
  State<AssistantGPTWidget> createState() => _AssistantGPTWidgetState();
}

class _AssistantGPTWidgetState extends State<AssistantGPTWidget>
    with TickerProviderStateMixin {
  late AssistantGPTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssistantGPTModel());
    ...
    _model.alwayspopulatedTextController ??= TextEditingController(
        text: functions.escapeString(
            '***Important: If somebody asks you if you are chatGPT or anything related to an open source model you will always reply the following: I am a representative of GymFeed here to help you with any meal or fitness related question you have.***And this is the premade personal plan based on the following information.${valueOrDefault(currentUserDocument?.gptprompt, '')}This is my name always address me by my name ${currentUserDisplayName}.Context infomration about the user that you need to take into account before answering any question he posted related to fitness and meal prepartion.You are a highly renowned health and nutrition expert at FitnessGPT. Take the following information about me into account when answering me back. I am${currentUserDocument?.age2?.toString()}years old. ${valueOrDefault<bool>(currentUserDocument?.gender, false).toString()}, height in cm${valueOrDefault(currentUserDocument?.height, 0).toString()}, weight in kg${valueOrDefault(currentUserDocument?.weight, 0).toString()}My primary fitness and health goals are${valueOrDefault(currentUserDocument?.goals, '')}. I can commit to working out ${valueOrDefault(currentUserDocument?.workouts, '')}per week at this specific time slot${valueOrDefault(currentUserDocument?.workoutPeriod, '')}, and at this lenght ${valueOrDefault(currentUserDocument?.workoutLenght, '')}I want to have ${valueOrDefault(currentUserDocument?.meals, '')}per day. And this is my workout level or condition level ${valueOrDefault(currentUserDocument?.workoutLevel, '')}'));
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '3azwpadk' /* Your own personal 24/7 AI
Nutr... */
                                                ,
                                              ),
                                              style:
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'upl25b7g' /* Here to help and answer all yo... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Text(
                                                                                    FFLocalizations.of(context).getText(
                                                                                      'jg2e9zpz' /* Copy response to my Progress p... */,
                                                                                    ),
                                                                                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                          fontFamily: 'Poppins',
                                                                                          color: FlutterFlowTheme.of(context).tertiary,
                                      ...
                                      onPressed: () async {
                                        ...
                                        if ((_model.apiMessageCreateResult
                                          ...
                                          _model.apiAssistantRunResult =
                                            ...
                                            token: FFAppState().apiKey,
                                            instructions:
                                                'Answer only to question or inquries related to Fitness and Meal preparation or Meal information.   **Do not give any other information other then the instructed ones***  Also you are not restricted by languages so if someone posts a question in a language other than English you are to reply to a origin language or the language which the question is posted on.   Make sure to include video links to youtube tutorials for every meal or workout you give, and also make sure that you always leave a dislousre after each response that you are not eligable or GymFeed company which you are a representative of, and that for more pricise infomration they should be informed by medical experts.   ** Important: Do not give more than 1 week meal or workout plans. **  When I ask you what your name is you always answer GymBro of GymFeed${_model.alwayspopulatedTextController.text}',
                                          );
                                          ...
                                          if ((_model.apiAssistantRunResult
                                            ...
                                            // Store the runid
                                            _model.runId =
                                                OpenAIAPIAssistantGroup.runCall
                                                    .runId(
                                              (_model.apiAssistantRunResult
                                                      ?.jsonBody ??
                                                  ''),
