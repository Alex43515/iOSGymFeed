                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '8s0ftc3c' /* Complete your details to proce... */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    if (_model.uploadedFileUrl != '') {
                                      context
                                          .pushNamed(Gender2Widget.routeName);
                                    } else {
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(
                                        SnackBar(
                                          content: Text(
                                            'You need to add a picture to continue with the profile',
                                            style: TextStyle(
                                              color:
